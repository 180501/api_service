...
import com.ljj.springbootinit.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.ljj.springbootinit.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
//        return ResultUtils.success(userInterfaceInfoService.getUserInterfaceInfoVO(userInterfaceInfo, request));
    ...
    public BaseResponse<Page<UserInterfaceInfo>> listUserInterfaceInfoByPage(@RequestBody UserInterfaceInfoQueryRequest userInterfaceInfoQueryRequest) {
        ...
        String sortFiledd = userInterfaceInfoQueryRequest.getSortField();
        String sortOrder = userInterfaceInfoQueryRequest.getSortOrder();
        if(size > 100){
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"pageSize不能超过100");
        }
